          ...
          <div className="flex justify-between items-center h-20">
            ...
            <div className="hidden md:flex items-center space-x-8">
              {isAuthenticated ? (
                ...
                <>
                  <button onClick={() => openAuthModal('login')} className="text-gray-600 font-medium hover:text-gray-900 transition-colors duration-200">
                    Log in
                  </button>
                  <button onClick={() => openAuthModal('signup')} className="bg-linear-to-r from-lime-500 to-green-500 hover:from-lime-600 hover:to-green-600 text-white font-semibold py-2.5 px-6 rounded-full shadow-lg shadow-lime-500/30 hover:shadow-lime-500/50 transform hover:-translate-y-0.5 transition-all duration-300">
                    Sign up
                  </button>
                </>
              )}
